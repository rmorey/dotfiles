...
hi ErrorMsg		  term=standout  cterm=bold  ctermfg=black  ctermbg=white  guifg=White  guibg=Red
...
hi MatchParen	  term=reverse  ctermbg=white ctermfg=darkgreen guibg=Blue  
